...
func (suite *DotnetConsoleTestSuite) SetupSuite() {
...
func (suite *DotnetConsoleTestSuite) TearDownSuite() {
...
func (suite *DotnetConsoleTestSuite) SetupTest() {
}
func (suite *DotnetConsoleTestSuite) TearDownTest() {
}

func (suite *DotnetConsoleTestSuite) TestCreateBasicProject() {

	name := suite.faker.Project.Name()
...
func (suite *DotnetConsoleTestSuite) TestCreateGroupProject() {
...
func (suite *DotnetConsoleTestSuite) TestCreateGroupLayeredProject() {
...
func (suite *DotnetConsoleTestSuite) TestCreateGroupNTierProject() {
...
func TestDotnetConsoleTestSuite(t *testing.T) {
	suite.Run(t, new(DotnetConsoleTestSuite))
}
