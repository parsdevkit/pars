...
func (suite *ProjectServiceVariousMultiplePathGroupProjectReferenceTestSuite) SetupSuite() {
...
func (suite *ProjectServiceVariousMultiplePathGroupProjectReferenceTestSuite) TearDownSuite() {
...
func (suite *ProjectServiceVariousMultiplePathGroupProjectReferenceTestSuite) SetupTest() {
}
func (suite *ProjectServiceVariousMultiplePathGroupProjectReferenceTestSuite) TearDownTest() {
}

func (suite *ProjectServiceVariousMultiplePathGroupProjectReferenceTestSuite) Test_CreateBasicProject_MultipleReferences_WithEmptyPath() {

	referenceProjectGroupName1 := suite.faker.Project.Group()
	referenceProjectGroupPath1 := suite.faker.Project.Path(3)
	...
	referenceProjectGroupPath2 := suite.faker.Project.Path(3)
...
func (suite *ProjectServiceVariousMultiplePathGroupProjectReferenceTestSuite) Test_CreateBasicProject_MultipleReferences_WithDefaultPath() {
...
func (suite *ProjectServiceVariousMultiplePathGroupProjectReferenceTestSuite) Test_CreateBasicProject_MultipleReferences_WithSinglePath() {
...
func (suite *ProjectServiceVariousMultiplePathGroupProjectReferenceTestSuite) Test_CreateBasicProject_MultipleReferences_WithMultiplePath() {
...
func TestProjectServiceVariousMultiplePathGroupProjectReferenceTestSuite(t *testing.T) {
	suite.Run(t, new(ProjectServiceVariousMultiplePathGroupProjectReferenceTestSuite))
}
