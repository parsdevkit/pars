...
func (suite *ProjectServiceVariousDefaultPathGroupProjectReferenceTestSuite) SetupSuite() {
...
func (suite *ProjectServiceVariousDefaultPathGroupProjectReferenceTestSuite) TearDownSuite() {
...
func (suite *ProjectServiceVariousDefaultPathGroupProjectReferenceTestSuite) SetupTest() {
}
func (suite *ProjectServiceVariousDefaultPathGroupProjectReferenceTestSuite) TearDownTest() {
}

func (suite *ProjectServiceVariousDefaultPathGroupProjectReferenceTestSuite) Test_CreateBasicProject_MultipleReferences_WithEmptyPath() {
	...
	referenceProject1.Specifications.GroupObject = group.NewGroupSpecification(0, referenceProjectGroupName1, referenceProjectGroupName1, []string{})
	...
	referenceProject2.Specifications.GroupObject = group.NewGroupSpecification(0, referenceProjectGroupName2, referenceProjectGroupName2, []string{})
...
func (suite *ProjectServiceVariousDefaultPathGroupProjectReferenceTestSuite) Test_CreateBasicProject_MultipleReferences_WithDefaultPath() {
...
func (suite *ProjectServiceVariousDefaultPathGroupProjectReferenceTestSuite) Test_CreateBasicProject_MultipleReferences_WithSinglePath() {
...
func (suite *ProjectServiceVariousDefaultPathGroupProjectReferenceTestSuite) Test_CreateBasicProject_MultipleReferences_WithMultiplePath() {
...
func TestProjectServiceVariousDefaultPathGroupProjectReferenceTestSuite(t *testing.T) {
	suite.Run(t, new(ProjectServiceVariousDefaultPathGroupProjectReferenceTestSuite))
}
