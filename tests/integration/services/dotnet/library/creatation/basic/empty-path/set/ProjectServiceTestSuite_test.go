...
func (suite *ProjectServiceTestSuite) Test_CreateBasicProject_EmptySet() {
	...
	_, err := suite.service.Create(project, true)
...
func (suite *ProjectServiceTestSuite) Test_CreateBasicProject_CustomSet() {

	projectName := suite.faker.Project.Name()
	projectSet := suite.faker.Project.Set()
	project := *objects.BasicProject_WithName(projectName, models.ProjectTypes.Library, models.PlatformTypes.Dotnet, models.RuntimeTypes.Dotnet, suite.workspace)
	project.Specifications.Set = projectSet
