...
type ProjectServiceVariousSinglePathGroupProjectReferenceTestSuite struct {
	suite.Suite
...
func (suite *ProjectServiceVariousSinglePathGroupProjectReferenceTestSuite) SetupSuite() {
...
func (suite *ProjectServiceVariousSinglePathGroupProjectReferenceTestSuite) TearDownSuite() {
...
func (suite *ProjectServiceVariousSinglePathGroupProjectReferenceTestSuite) SetupTest() {
}
func (suite *ProjectServiceVariousSinglePathGroupProjectReferenceTestSuite) TearDownTest() {
}

func (suite *ProjectServiceVariousSinglePathGroupProjectReferenceTestSuite) Test_CreateBasicProject_MultipleReferences_WithEmptyPath() {

	referenceProjectGroupName1 := suite.faker.Project.Group()
	referenceProjectGroupPath1 := suite.faker.Project.Path(1)
	...
	referenceProject1.Specifications.GroupObject = group.NewGroupSpecification(0, referenceProjectGroupName1, referenceProjectGroupPath1, []string{})
	...
	referenceProjectGroupPath2 := suite.faker.Project.Path(1)
	...
	referenceProject2.Specifications.GroupObject = group.NewGroupSpecification(0, referenceProjectGroupName2, referenceProjectGroupPath2, []string{})
...
func (suite *ProjectServiceVariousSinglePathGroupProjectReferenceTestSuite) Test_CreateBasicProject_MultipleReferences_WithDefaultPath() {
...
func (suite *ProjectServiceVariousSinglePathGroupProjectReferenceTestSuite) Test_CreateBasicProject_MultipleReferences_WithSinglePath() {
...
func (suite *ProjectServiceVariousSinglePathGroupProjectReferenceTestSuite) Test_CreateBasicProject_MultipleReferences_WithMultiplePath() {
...
func TestProjectServiceVariousSinglePathGroupProjectReferenceTestSuite(t *testing.T) {
	suite.Run(t, new(ProjectServiceVariousSinglePathGroupProjectReferenceTestSuite))
}
