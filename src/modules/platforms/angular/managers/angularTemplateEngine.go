...
func (s *AngularTemplateEngine) RenderTemplate(tmplFile string, templateName string, outputFile string, data any) error {
...
func (*AngularTemplateEngine) GetContent(tmplFile string, templateName string, data any) (string, error) {
