...
type FileTemplateSerializer struct{}

func (s FileTemplateSerializer) GetTemplateStructsFromString(data string) ([]filetemplate.TemplateBaseStruct, error) {
	templates := make([]filetemplate.TemplateBaseStruct, 0)
	...
	for _, line := range yamlLines {
		...
		if header.Type == structs.StructTypes.Template {
			...
			if resourceHeader.Kind == template.StructKinds.File {
				var templateDefinitionStruct = filetemplate.TemplateBaseStruct{}
...
func (s FileTemplateSerializer) GetTemplateStructsFromFile(files ...string) ([]filetemplate.TemplateBaseStruct, error) {
	templates := make([]filetemplate.TemplateBaseStruct, 0)
...
func (s FileTemplateSerializer) CompleteTemplateInformation(template *filetemplate.TemplateBaseStruct) error {
...
func (s FileTemplateSerializer) GetWorkspace(template filetemplate.TemplateBaseStruct) (*workspace.WorkspaceBaseStruct, error) {
