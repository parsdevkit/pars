...
add_custom_target(build.deb.package.all.package DEPENDS check_env_for_deb_packing ${DEB_OUTPUT_DIR})

add_custom_target(build.deb.package.all)
add_dependencies(build.deb.package.all 
    # build.deb.package.setup
    build.deb.package.all.configuration
    build.deb.package.all.payload
    build.deb.package.all.package
)