...
set(CHOCOARCH_LIST_WINDOWS "${CHOCO_ARCH_X86};${CHOCO_ARCH_X86_64};${CHOCO_ARCH_ARM64}")
set(ALL_CHOCOARCH_LIST_WINDOWS ${CHOCOARCH_LIST_WINDOWS})
list(APPEND ALL_CHOCOARCH_LIST_LINUX ${CHOCO_ARCH_ALL})
...
set(CHOCO_BUILD_CONFIG_DIR "${CHOCO_ROOT_DIR}/${APP_NAME}")
set(CHOCO_BUILD_PAYLOAD_DIR "${CHOCO_ROOT_DIR}/${APP_NAME}")
