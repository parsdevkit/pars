...
set(MSI_SERIES jammy) #focal
set(MSI_PACKAGE_EXT .msi)
set(MSI_PACKAGE_NAME msi)
set(MSI_PACK_TYPE "source")
set(MSI_BASE "core22")

set(MSIARCH_LIST_LINUX "${MSI_ARCH_X86};${MSI_ARCH_X86_64};${MSI_ARCH_ARM};${MSI_ARCH_ARM64}")
set(ALL_MSIARCH_LIST_LINUX ${MSIARCH_LIST_LINUX})
list(APPEND ALL_MSIARCH_LIST_LINUX ${MSI_ARCH_ALL})
...
set(MSI_ROOT_DIR "${CMAKE_BINARY_DIR}/msi")
