...
func (s FileTemplateService) Generate(model filetemplate.TemplateBaseStruct) (*filetemplate.TemplateBaseStruct, error) {
	...
	templateEngine := NewFileTemplateEngine(s.environment)
...
func (s FileTemplateService) IsExists(name, workspace string) bool {
