...
func (s ObjectResourceService) Generate(model objectresource.ResourceBaseStruct) (*objectresource.ResourceBaseStruct, error) {
	...
	templateEngine := NewCodeTemplateEngine(s.environment)
