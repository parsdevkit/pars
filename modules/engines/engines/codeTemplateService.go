...
func (s CodeTemplateService) CreateTemplatesFromTemplate(init bool, data any, templateFiles ...string) error {
...
func (s CodeTemplateService) CreateTemplatesFromFile(init bool, files ...string) error {
	if len(files) > 0 {
...
func (s CodeTemplateService) RemoveTemplatesFromFile(permanent bool, files ...string) error {
	if len(files) > 0 {
...
func (s CodeTemplateService) CreateTemplates(templates []codetemplate.TemplateBaseStruct, init bool) error {
...
func (s CodeTemplateService) RemoveTemplates(templates []codetemplate.TemplateBaseStruct, permanent bool) error {
