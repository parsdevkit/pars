...
func (s DataResourceService) CreateResourcesFromTemplate(init bool, data any, resourceFiles ...string) error {
...
func (s DataResourceService) CreateResourcesFromFile(init bool, files ...string) error {
	if len(files) > 0 {
...
func (s DataResourceService) RemoveResourcesFromFile(permanent bool, files ...string) error {
	if len(files) > 0 {
...
func (s DataResourceService) CreateResources(resources []dataresource.ResourceBaseStruct, init bool) error {
...
func (s DataResourceService) RemoveResources(resources []dataresource.ResourceBaseStruct, permanent bool) error {
