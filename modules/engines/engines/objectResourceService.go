...
func (s ObjectResourceService) CreateResourcesFromTemplate(init bool, data any, resourceFiles ...string) error {
...
func (s ObjectResourceService) CreateResourcesFromFile(init bool, files ...string) error {
	if len(files) > 0 {
...
func (s ObjectResourceService) RemoveResourcesFromFile(permanent bool, files ...string) error {
	if len(files) > 0 {
...
func (s ObjectResourceService) CreateResources(resources []objectresource.ResourceBaseStruct, init bool) error {
	...
	for _, resource := range resourcesReadyToCreate {
		...
		if _, err := resourceService.Generate(resource); err != nil {
			return err
		}
...
func (s ObjectResourceService) RemoveResources(resources []objectresource.ResourceBaseStruct, permanent bool) error {
