...
func (s ApplicationProjectService) CreateProjectsFromTemplate(workspaceName string, init bool, data any, templateFiles ...string) error {
...
func (s ApplicationProjectService) CreateProjectsFromFile(workspaceName string, init bool, files ...string) error {
...
func (s ApplicationProjectService) RemoveProjectsFromFile(workspaceName string, permanent bool, files ...string) error {
	logrus.Debugf("found %v file(s) to create project", len(files))
...
func (s ApplicationProjectService) CreateProjects(projects []applicationproject.ProjectBaseStruct, init bool) error {
...
func (s ApplicationProjectService) RemoveProjects(projects []applicationproject.ProjectBaseStruct, permanent bool) error {
...
func (s ApplicationProjectService) SortProjectsByReference(projects []applicationproject.ProjectBaseStruct) ([]applicationproject.ProjectBaseStruct, error) {
