...
func (s SharedTemplateService) CreateTemplatesFromTemplate(init bool, data any, templateFiles ...string) error {
...
func (s SharedTemplateService) CreateTemplatesFromFile(init bool, files ...string) error {
	if len(files) > 0 {
...
func (s SharedTemplateService) RemoveTemplatesFromFile(permanent bool, files ...string) error {
	if len(files) > 0 {
...
func (s SharedTemplateService) CreateTemplates(templates []sharedtemplate.TemplateBaseStruct, init bool) error {
...
func (s SharedTemplateService) RemoveTemplates(templates []sharedtemplate.TemplateBaseStruct, permanent bool) error {
