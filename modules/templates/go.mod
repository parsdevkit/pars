module parsdevkit.net/templates2gecici
...
require (
	...
	parsdevkit.net/modules/services v0.0.0-00010101000000-000000000000
	...
	parsdevkit.net/template/context v0.0.0-00010101000000-000000000000
)
