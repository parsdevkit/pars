...
func (s CommonTaskService) Remove(name string, permanent bool) (*commontask.TaskBaseStruct, error) {
	//TODO: Geçici olarak tanımlandı, düzenlenecek

	taskTaskEntity, err := s.taskRespository.GetByName(name)
	if err != nil {
		return nil, err
	}
...
func (s CommonTaskService) IsExists(name string) bool {
