...
func (s ObjectResourceService) Remove(name string, force, permanent bool) (*objectresource.ResourceBaseStruct, error) {
...
func (s ObjectResourceService) IsExists(name string) bool {
