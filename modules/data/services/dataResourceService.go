...
func (s DataResourceService) Remove(name string, force, permanent bool) (*dataresource.ResourceBaseStruct, error) {
...
func (s DataResourceService) IsExists(name string) bool {
