...
func (s CodeTemplateService) Remove(name string, permanent bool) (*codetemplate.TemplateBaseStruct, error) {
...
func (s CodeTemplateService) IsExists(name string) bool {
