...
func (s SharedTemplateService) Remove(name string, permanent bool) (*sharedtemplate.TemplateBaseStruct, error) {
...
func (s SharedTemplateService) IsExists(name string) bool {
