...
replace parsdevkit.net/modules/services => ./modules/data/services
...
replace parsdevkit.net/template/context => ./modules/context
...
replace parsdevkit.net/manifest/services => ./modules/engines

replace parsdevkit.net/templates2gecici => ./modules/templates
...
require (
	...
	parsdevkit.net/manifest/services v0.0.0-00010101000000-000000000000 // indirect
	parsdevkit.net/modules/services v0.0.0-00010101000000-000000000000 // indirect
	...
	parsdevkit.net/template/context v0.0.0-00010101000000-000000000000 // indirect
	parsdevkit.net/templates2gecici v0.0.0-00010101000000-000000000000 // indirect
)
